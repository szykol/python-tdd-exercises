...
[![Build Status](https://travis-ci.org/szykol/python-tdd-exercises.svg?branch=master)](https://travis-ci.org/szykol/python-tdd-exercises/builds)
[![Coverage Status](https://coveralls.io/repos/szykol/python-tdd-exercises/badge.png?branch=master)](https://coveralls.io/r/szykol/python-tdd-exercises?branch=master)
...
- Increase the test coverage to 100% by making [all lines](https://coveralls.io/r/szykol/python-tdd-exercises?branch=master) green.
